...
/*
  ...
  ONE CENTRED COLUMN, ON PURPOSE. This was briefly rebuilt as a two-column sheet
  with a right-hand contact rail, and Adam reverted it: "put it back into the
  original format." So do not "fix" this into a wide layout again. The centred
  measure is the design; a card is not a page, and filling 1440px of width with
  six lines of content is what makes a card look like an abandoned site.
*/
