        ...
        !function(n2) {
          ...
          var i2 = "function", a2 = "undefined", o = "object", s = "string", l = "major", u = "model", c = "name", d = "type", h = "vendor", p = "version", f = "architecture", g = "console", v = "mobile", m = "tablet", b = "smarttv", _ = "wearable", y = "embedded", w = "Amazon", E = "Apple", x = "ASUS", C = "BlackBerry", R = "Browser", O = "Chrome", S = "Firefox", T = "Google", P = "Huawei", N = "Microsoft", A = "Motorola", I = "Opera", k = "Samsung", M = "Sharp", j = "Sony", D = "Xiaomi", L = "Zebra", $ = "Facebook", q = "Chromium OS", U = "Mac OS", B = function(e2, t3) {
            ...
            return this.getBrowser = function() {
              ...
              var e3 = {};
              return e3[c] = void 0, e3[p] = void 0, X.call(e3, g2, _2.os), y2 && !e3[c] && b2 && "Unknown" != b2.platform && (e3[c] = b2.platform.replace(/chrome os/i, q).replace(/macos/i, U)), e3;
  ...
  `), Object.defineProperty(this, "__NEXT_ERROR_CODE", { value: "E1177", enumerable: false, configurable: true });
      ...
      class q {
        ...
        formatPathname() {
          ...
          }((e10 = { basePath: this[$].basePath, buildId: this[$].buildId, defaultLocale: this[$].options.forceLocale ? void 0 : this[$].defaultLocale, locale: this[$].locale, pathname: this[$].url.pathname, trailingSlash: this[$].trailingSlash }).pathname, e10.locale, e10.buildId ? void 0 : e10.defaultLocale, e10.ignorePrefix), (e10.buildId || !e10.trailingSlash) && (t10 = P(t10)), e10.buildId && (t10 = I(A(t10, `/_next/data/${e10.buildId}`), "/" === e10.pathname ? "index.json" : ".json")), t10 = A(t10, e10.basePath), !e10.buildId && e10.trailingSlash ? t10.endsWith("/") ? t10 : I(t10, "/") : P(t10);
        }
        formatSearch() {
      ...
      var U, B, H, V, F, G, X, z, W, K, J, Q, Y, Z, ee, et, er = e.i(28042);
      ...
      class ei extends Request {
        constructor(e10, t10 = {}) {
          ...
          const n2 = new q(r2, { headers: E(this.headers), nextConfig: t10.nextConfig });
      ...
      class eu extends Response {
        constructor(e10, t10 = {}) {
          ...
          this[eo] = { cookies: n2, url: t10.url ? new q(t10.url, { headers: E(r2), nextConfig: t10.nextConfig }) : void 0 };
        }
        [Symbol.for("edge-runtime.inspect.custom")]() {
      ...
      let eY = (e10, t10) => {
        ...
        trace(...e10) {
          ...
          let { fn: s2, options: l2 } = "function" == typeof r2 ? { fn: r2, options: {} } : { fn: n2, options: { ...r2 } }, u2 = l2.spanName ?? t10, c2 = l2.parentSpan ?? this.getActiveScopeSpan(), d2 = c2 && (null == a2 ? void 0 : a2.isOpenTelemetryIsolatedSpan(c2)) ? c2 : void 0, h2 = !d2 && (eU.has(t10) || "1" === process.env.NEXT_OTEL_VERBOSE);
      ...
      let tL = tj("\x1B[31m", "\x1B[39m"), t$ = tj("\x1B[32m", "\x1B[39m"), tq = tj("\x1B[33m", "\x1B[39m");
      tj("\x1B[34m", "\x1B[39m");
      let tU = tj("\x1B[35m", "\x1B[39m");
      tj("\x1B[38;2;173;127;168m", "\x1B[39m"), tj("\x1B[36m", "\x1B[39m");
      let tB = tj("\x1B[37m", "\x1B[39m");
      tj("\x1B[90m", "\x1B[39m"), tj("\x1B[40m", "\x1B[49m"), tj("\x1B[41m", "\x1B[49m"), tj("\x1B[42m", "\x1B[49m"), tj("\x1B[43m", "\x1B[49m"), tj("\x1B[44m", "\x1B[49m"), tj("\x1B[45m", "\x1B[49m"), tj("\x1B[46m", "\x1B[49m"), tj("\x1B[47m", "\x1B[49m"), tB(tD("\u25CB")), tL(tD("\u2A2F")), tq(tD("\u26A0")), tB(tD(" ")), t$(tD("\u2713")), tU(tD("\xBB")), new tN(1e4, (e10) => e10.length), new tN(1e4, (e10) => e10.length);
      ...
      RegExp("\\n\\s+at Suspense \\(<anonymous>\\)(?:(?!\\n\\s+at (?:body|div|main|section|article|aside|header|footer|nav|form|p|span|h1|h2|h3|h4|h5|h6) \\(<anonymous>\\))[\\s\\S])*?\\n\\s+at __next_root_layout_boundary__ \\([^\\n]*\\)"), RegExp("\\n\\s+at __next_metadata_boundary__[\\n\\s]"), RegExp("\\n\\s+at __next_viewport_boundary__[\\n\\s]"), RegExp("\\n\\s+at __next_outlet_boundary__[\\n\\s]"), RegExp("\\n\\s+at __next_instant_validation_boundary__[\\n\\s]"), RegExp("\\n\\s+at __next_instant_slot_(\\d+)__[\\n\\s]"), ew(), e.s(["config", 0, { matcher: ["/((?!_next/static|_next/image|favicon.ico).*)"] }, "middleware", 0, function(e10) {
        let t10 = new URL(e10.url);
        if ("localhost" === t10.hostname || "127.0.0.1" === t10.hostname) return eu.next();
        let r2 = e10.headers.get("x-forwarded-proto"), n2 = r2?.split(",")[0]?.trim();
        if (!n2) try {
          n2 = JSON.parse(e10.headers.get("cf-visitor") || "{}").scheme;
        } catch {
        }
        return "http" === n2 ? (t10.protocol = "https:", eu.redirect(t10, 301)) : eu.next();
      }], 99446);
